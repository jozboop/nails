          ...
          <form onSubmit={handleProfileSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-pink-200 focus:border-pink-300 transition-all duration-200"
                required
              />
            </div>
            ...
            <div className="flex space-x-4">
              <button
                type="submit"
                disabled={uploading}
                className="px-6 py-3 bg-pink-500 text-white rounded-lg hover:bg-pink-600 transition-colors disabled:opacity-50 font-medium"
              >
